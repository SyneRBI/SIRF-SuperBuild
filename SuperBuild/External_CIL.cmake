...
if(NOT ( DEFINED "USE_SYSTEM_${externalProjName}" AND "${USE_SYSTEM_${externalProjName}}" ) )
  ...
  if("${PYTHON_STRATEGY}" STREQUAL "PYTHONPATH")
    ...
    ExternalProject_Add(${proj}
      ...
      # external projects
      PATCH_COMMAND ${Python3_EXECUTABLE} ${CMAKE_SOURCE_DIR}/patches/cil-patch.py ${${proj}_SOURCE_DIR}/Wrappers/Python/cil/utilities/dataexample.py
      UPDATE_COMMAND ""
  ...
  add_test(NAME CIL_FRAMEWORK_TESTS_1
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_DataContainer.py 
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_2
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_algor*.py 
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_3
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_run_*.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_SIRF_TESTS
          COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_SIRF*.py
          WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_4
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_Block_*.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_5
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_dataexample.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_6
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_functions.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_7
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_Gradient.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_8
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_NexusReaderWriter.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_9
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_Operator.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_10
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_PluginsRegularisation.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_11
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_quality_measures.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_12
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_smoothMixedL21Norm.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_13
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_subset.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_14
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_SumFunction.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
  add_test(NAME CIL_FRAMEWORK_TESTS_15
           COMMAND ${Python3_EXECUTABLE} -m unittest discover -p test_TranslateFunction.py
           WORKING_DIRECTORY ${${proj}_SOURCE_DIR}/Wrappers/Python/test)
