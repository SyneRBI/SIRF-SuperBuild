...
## v1.0.0
 ...
 - major [restructuring](https://github.com/SynerBI/SIRF-SuperBuild/issues/16#issuecomment-360772097) of SuperBuild build directory
 - User can specify the location of the sources via the variable `SOURCES_ROOT_DIR`
 - Updated dependency versions (STIR)
 - Defaults to `USE_SYSTEM_BOOST=ON` on Windows and MacOSX [#63](https://github.com/SynerBI/SIRF-SuperBuild/issues/63), see [here](https://github.com/SynerBI/SIRF/wiki/SIRF-SuperBuild-on-MacOS#2-boost-)
